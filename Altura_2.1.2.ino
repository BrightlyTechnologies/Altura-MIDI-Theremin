...
void checkScalePot(int scalePot){
  ...
  noteBuffer =  noteBufferSpace / notesInCurrentScale; 
    SetScale();               
...
long checkNoteBuffer(long reading){
   ...
   if (reading > map(lastNote + 1, 0, notesInCurrentScale + 1, minimumDistance, maximumDistance) + noteBuffer || reading < map(lastNote, 0, notesInCurrentScale + 1, minimumDistance, maximumDistance) - noteBuffer) 
  {
